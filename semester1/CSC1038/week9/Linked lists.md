...
- use singly linked lists when you want to store some information and access elements only once

# Doubly linked lists

- use doubly linked lists when you want to access elements multiple times
- in a doubly linked lists we just have another pointer to the previous nod
- `*prev` stores the information of the previous node
- this allows us to go back and forth through the nodes easily
- first allocate memory for the current
- after you get all the data you need for that iteration, `current->prev = prev;`
- 
```c
#include<stdio.h>
#include<stdlib.h>
